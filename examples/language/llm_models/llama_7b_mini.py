...
def build_llama_mini_program(
    ...
    class LlamaMiniProgram:
        ...
        def kernel_matmul_trans_b(
            ...
            """[S,D] @ [S,D]^T → [S,S]: Q @ K^T via K-tiled 16-wide blocks.
            ...
            b0 = pl.load(b, [0, 0], [seq_len, k_tile_width], target_memory=pl.MemorySpace.Mat)
            ...
            b1 = pl.load(b, [0, k1], [seq_len, k_tile_width], target_memory=pl.MemorySpace.Mat)
            ...
            b2 = pl.load(b, [0, k2], [seq_len, k_tile_width], target_memory=pl.MemorySpace.Mat)
            ...
            b3 = pl.load(b, [0, k3], [seq_len, k_tile_width], target_memory=pl.MemorySpace.Mat)
        ...
        def llama_mini_orch(  # noqa: PLR0913
            ...
            k_rot: pl.Tensor[[seq_len, head_dim], pl.FP32] = pl.create_tensor(
                [seq_len, head_dim], dtype=pl.FP32
            )
